    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">PawPlate</h1>
          <p className="text-muted-foreground text-sm mt-1">Nutrition for your best friend</p>
        </div>
          ...
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              {mode === 'login'
                ...
                : 'Start planning balanced meals for your pet'}
            </CardDescription>
          </CardHeader>
